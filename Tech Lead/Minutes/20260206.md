...
- release 2.14 update: @schlunma (with @jlenh and @flicj191 as release buddies):
  ...
  - ESMValTool Milestones: few bookkeeping (renaming files etc), couple cmorizers, one MO diagnostic, ESA-related cmorizers that @schlunma will ask Axel - **we should do tech review** - @jlenh, @flicj191 "volunteered" - thank you, @bouweandela looking at distributing them
...
- @bouweandela: showing us traffic metrics from visitors to ESMValCore/Tool documentation and tutorial and website (newly implemented via Matomo)
